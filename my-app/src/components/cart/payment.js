...
//     // const { isOrderPlaced, error } = useSelector(state => state.OrderState);
...
//     cartItems.map(i => {
//         const tourAmount = Number(i.price * i.quantity);
//         amount += tourAmount;
//     })
...
//                         <input type="name" id="name_field" className="form-control" name='name' value={name} onChange={e => setName(e.target.value)} required />
//                     </div>
...
//                     <button type="submit" className="btn update-btn btn-block mt-4 mb-3">Proceed</button>
//                 </form>
//             </div>
//         </div>
//     )
